...
* [Welcome to Datashare's User Guide](README.md)

## MAC

* [Install Datashare on Mac](mac/install-datashare-on-mac.md)
* [Open Datashare](mac/open-datashare-on-mac.md)
* [Add documents to Datashare](mac/add-documents-to-datashare-on-mac.md)

## WINDOWS

* [Install Datashare on Windows](windows/install-datashare-on-windows.md)
* [Open Datashare](windows/open-datashare-on-windows.md)
* [Add documents to Datashare](windows/add-documents-to-datashare-on-windows.md)

## LINUX

* [Install Datashare on Linux](linux/install-datashare-on-linux.md)
* [Open Datashare](linux/open-datashare-on-linux.md)
* [Add documents to Datashare](linux/add-documents-to-datashare-on-linux.md)

## MAC \| WINDOWS \| LINUX <a id="all"></a>
...
* [Nothing works, everything crashes. What can I do?](faq/nothing-works-everything-crashes.-what-can-i-do.md)
* [What if tasks are 'running' but not completing?](faq/tasks-are-running-but-not-completing.md)
* [What if a 'Preview' of my documents is 'not available'?](faq/i-dont-see-any-preview-of-my-document..md)
* [What is a named entity?](faq/what-is-a-named-entity.md)
* [What are NLP pipelines?](faq/what-are-nlp-pipelines.md)
* [Can I download a document from Datashare?](faq/can-i-download-a-document.md)
* [Can I remove document\(s\) from Datashare?](faq/can-i-remove-a-document-from-datashare.md)
* [What does 'Windows named pipe error' mean?](faq/i-read-windows-named-pipe-error-....md)
