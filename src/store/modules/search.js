...
export function initialState () {
  return {
    ...
    facets: [
      ...
      features.methods.hasFeature('DATERANGE_PICKER') ? new FacetDateRange('creation-date', 'metadata.tika_metadata_creation_date', false, item => item.key === -62167219200000 ? 'facet.missing' : item.key_as_string) : new FacetDate('creation-date', 'metadata.tika_metadata_creation_date', false, item => item.key === -62167219200000 ? 'facet.missing' : item.key_as_string)
    ],
