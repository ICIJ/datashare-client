...
export const actions = {
  ...
  async onSubmit ({ state, commit, dispatch }, { name, published, csvFile, description, project, fuzziness }) {
    try {
      await datashare.batchSearch(name, published, csvFile, description, project, fuzziness)
