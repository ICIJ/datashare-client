...
export const REMOVE_BATCH_SEARCH = 'removeBatchSearch'
export const CLEAR_BATCH_SEARCH = 'clearBatchSearches'
export const RESULTS = 'results'
export const TOTAL = 'total'
export const NB_BATCH_SEARCHES = 'nbBatchSearches'
export const CLEAR_BATCH_SEARCH_RESULTS = 'clearBatchSearchResults'
