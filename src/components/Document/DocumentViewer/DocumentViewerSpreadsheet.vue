<template>
  ...
  >
    ...
    >
      ...
      <div
        class="spreadsheet-viewer__content__table mx-3 small flex-grow-1"
        :style="tableVars"
      >
        <dynamic-scroller
          :items="scrollerItems"
      ...
      <b-tabs
        v-if="nonEmptySheets.length > 1"
        v-model="activeSheetIndex"
        pills
        class="mx-3 mb-3"
      >
        <b-tab
          v-for="(sheet, i) in nonEmptySheets"
          :key="i"
          :title="sheet"
        />
      </b-tabs>
