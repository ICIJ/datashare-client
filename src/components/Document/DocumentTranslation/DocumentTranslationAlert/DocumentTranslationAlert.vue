...
<template>
  <div class="document-translation-alert alert flex-truncate d-flex align-items-center py-2" :class="classList">
    <phosphor-icon :name="PhTranslate" class="me-2 my-1 flex-shrink-0 d-none d-md-inline-flex" />
    <div class="d-flex align-items-center gap-1 gap-md-3 flex-wrap">
      ...
      <div class="d-flex gap-1 text-nowrap flex-truncate me-md-4">
        <document-translation-alert-source
          ...
          class="text-truncate"
        />
        <phosphor-icon :name="PhCaretRight" class="flex-shrink-0" variant="warning" />
