...
<template>
  <div
    v-for="i in repeat"
    :key="i"
    class="document-card-placeholder p-3 d-flex gap-3"
  >
    <div
      v-if="hasThumbnail"
      class="document-card-placeholder__thumbnail flex-grow-1"
    >
    ...
    <div
      class="document-card-placeholder__actions"
      :class="actionsClassList"
    >
      <app-placeholder
        width="1.75rem"
        height="1.75rem"
