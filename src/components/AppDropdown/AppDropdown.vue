...
watch(focusIndex, async () => {
  await nextTick()
  const focused = dropdown.value?.$el?.querySelector('.app-dropdown__item--focus')
...
<template>
  ...
  >
    ...
    <b-dropdown-item
      ...
      :link-class="{ 'p-0': true, 'app-dropdown__item--focus': focusIndex === index }"
