...
<template>
  <app-modal :image="image" :image-dark="imageDark" @ok="confirmDeletion">
    <template #title>
    ...
    <app-wait :for="loaderId">
      <i18n-t v-if="hasSomething" keypath="projectDeletionModal.body.all">
        ...
        <template #tags>
          <i18n-t keypath="projectDeletionModal.body.tags" tag="span" :plural="tagsCount">
            <template #count>
        ...
        <template #recommendations>
          <i18n-t keypath="projectDeletionModal.body.recommendations" tag="span" :plural="recommendationsCount">
            <template #count>
