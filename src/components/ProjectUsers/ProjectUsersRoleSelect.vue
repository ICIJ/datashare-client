...
<template>
  <div
    class="project-users-role-select"
    :class="{ 'project-users-role-select--dirty': dirty }"
  >
    <b-dropdown
      class="project-users-role-select__dropdown"
      no-caret
      variant="body"
      teleport-to="body"
    ...
    >
      ...
      <display-role :value="modelValue" class="project-users-role-select__value d-none" aria-hidden="true" />
      <b-dropdown-item
...
.project-users-role-select {
  ...
  &--dirty :deep(.project-users-role-select__toggle) {
