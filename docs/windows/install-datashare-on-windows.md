...
You will need **Windows 10 Pro or more recent versions.** For less recent versions, see [here](https://icij.gitbook.io/datashare/faq/how-can-i-install-datashare-on-a-windows-prior-to-windows-10-pro).  
****  
