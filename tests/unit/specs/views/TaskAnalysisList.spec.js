...
import TaskDocumentsList from '@/views/Task/Documents/TaskDocumentsList'
...
describe('TaskDocumentsList.vue', () => {
  const api = {
    index: vi.fn(),
  ...
  it('should display tasks list', async () => {
    const wrapper = mount(TaskDocumentsList, { global: { plugins: core.plugins } })
