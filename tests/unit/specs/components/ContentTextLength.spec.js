...
describe('ContentTextLengthWarning.vue', () => {
  ...
  const _source = { content: 'a content not really long but mocked', contentTextLength: 2e5 }
  let wrapper = null
  ...
  it('should emit an event when clicking on the "open" button', () => {
  ...
  it('should change when clicking on the "open" button', () => {
