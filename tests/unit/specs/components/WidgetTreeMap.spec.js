...
describe('WidgetTreeMap.vue', () => {
  ...
  it('should be a Vue instance', () => {
    ...
    const wrapper = shallowMount(WidgetTreeMap, { i18n, localVue, store, propsData, data () { return { id: 'widget_tree_map' } } })
  ...
  it('should display children names in the tree map without transformation', async () => {
    ...
    await shallowMount(WidgetTreeMap, { i18n, localVue, store, propsData, data () { return { id: 'widget_tree_map' } } })
  ...
  it('should display a link to a datashare search on the current path', async () => {
    const propsData = { widget: { baseDirname: '', getData () { return { children: [{ dirname: 'oldPart,newPart', doc_count: 26 }] } }, getTitle: item => item.data.dirname.replace('oldPart,', ''), getSubtitle: () => {} } }
    const wrapper = await shallowMount(WidgetTreeMap, { i18n, localVue, store, propsData, data () { return { id: 'widget_tree_map' } } })
