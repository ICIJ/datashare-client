...
// import vueDevTools from 'vite-plugin-vue-devtools' // Temporarily disabled due to localStorage issue
...
export default ({ mode }) => {
  ...
  return defineConfig({
    ...
    plugins: [
      vue(),
      // vueDevTools(), // Temporarily disabled due to localStorage issue
      /**
